...
func TestBadFactory(t *testing.T) {
	cache := newEndpointCache[any, any](func(string) (endpoint.Endpoint[any, any], io.Closer, error) {
...
func assertEndpointsLen(t *testing.T, cache *endpointCache[any, any], l int) {
...
func assertEndpointsError(t *testing.T, cache *endpointCache[any, any], wantErr string) {
	endpoints, err := cache.Endpoints()
	if err == nil {
