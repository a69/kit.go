...
See [addsvc.thrift](https://github.com/a69/kit.go/examples/blob/master/addsvc/thrift/addsvc.thrift) for an example.
...
See [thrift.go](https://github.com/a69/kit.go/examples/blob/master/addsvc/pkg/addtransport/thrift.go) for an example.
...
Fortunately, [addsvc](https://github.com/a69/kit.go/examples/tree/master/addsvc) is a complete working example with Thrift support.
